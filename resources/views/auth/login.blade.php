<x-guest-layout>
    <h1 class="text-xl font-bold text-center text-gray-700 dark:text-white">Login to your Momentum account</h1>
        ...
        <a href="{{ route('socialite.redirect', 'google') }}" class="flex items-center justify-center bg-gray-100 dark:bg-gray-800 border border-indigo-600 dark:border-indigo-400 text-indigo-600 dark:text-indigo-400 p-3 rounded-full hover:bg-indigo-50 dark:hover:bg-gray-700 transition-all">
            <svg width="28" height="28" viewBox="0 0 20 20">
                <g>
                    ...
                    <path fill="#34A853" d="M10 20c2.7 0 4.97-.89 6.63-2.44l-3.34-2.56c-.92.62-2.09.99-3.29.99-2.53 0-4.68-1.71-5.44-4.01H1.09v2.52C2.82 17.98 6.18 20 10 20z" />
                    <path fill="#FBBC05" d="M4.56 12.98A5.97 5.97 0 0 1 4.09 10c0-.99.18-1.95.47-2.98V4.5H1.09A9.96 9.96 0 0 0 0 10c0 1.64.39 3.19 1.09 4.5l3.47-2.52z" />
                    <path fill="#EA4335" d="M10 4c1.48 0 2.8.51 3.85 1.51l2.89-2.89C14.97 1.18 12.7 0 10 0 6.18 0 2.82 2.02 1.09 5.5l3.47 2.52C5.32 5.71 7.47 4 10 4z" />
                </g>
            </svg>
        </a>
