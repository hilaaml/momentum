...
<head>
    ...
    <title>{{ config('app.name', 'Momentum') }}</title>
...
<body class="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex items-center justify-center p-6">
